        ...
        <div className="min-h-screen bg-bg-app flex items-center justify-center px-4">
            ...
            >
                ...
                <div className="text-center space-y-3">
                    ...
                    <h1 className="text-2xl font-extrabold text-white">LinguaCore</h1>
                    <p className="text-sm text-text-muted">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-3">
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className="w-full bg-bg-card border border-border rounded-xl pl-11 pr-4 py-3 text-sm text-white placeholder:text-text-muted focus:outline-none focus:border-primary/50 transition-colors"
                            />
                        </div>
                        <div className="relative">
                    ...
                    <button
                        type="submit"
                        disabled={submitting}
                        className="w-full bg-primary hover:bg-primary-dark text-bg-app font-bold py-3 rounded-xl transition-all active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                        {submitting ? (
                ...
                <button
                    ...
                    className="w-full bg-bg-card border border-border hover:border-primary/30 text-white font-medium py-3 rounded-xl transition-all flex items-center justify-center gap-3"
                >
